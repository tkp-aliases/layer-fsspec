...
lint-py:  ## lint python with ruff
	python -m ruff check layer_fsspec
	python -m ruff format --check layer_fsspec
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix layer_fsspec
	python -m ruff format layer_fsspec
...
test:  ## run python tests
	python -m pytest -v layer_fsspec/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v layer_fsspec/tests --cov=layer_fsspec --cov-report term-missing --cov-report xml
